...
<?php
    ...
    /* verifica se alguma coisa se encontra no ficheiro, se nao se encontrar devolve "Indiponivel", se encontrar devolve o status da caixa, se está fechada ou aberta*/

    if( filesize("API/Files/Caixa1/status.txt") == FALSE){

        $status_caixa1 = "N/A";

    } else {
        $status_caixa1 = file_get_contents("API/Files/Caixa1/status.txt");
         $status_caixa1 = openssl_decrypt($status_caixa1, $cipher, $key, $options=0, $iv);
    }
    
    if( filesize("API/Files/Caixa1/hora.txt") == FALSE ){

        $hora_caixa1 = "Indisponivel";

    }else {
        $hora_caixa1 = file_get_contents("API/Files/Caixa2/hora.txt"); 
        $hora_caixa1 = openssl_decrypt($hora_caixa1, $cipher, $key, $options=0, $iv);
    }
    
    if( filesize("API/Files/Caixa2/status.txt") == FALSE ){

        $status_caixa2 = "N/A";

    }else {
        $status_caixa2 = file_get_contents("API/Files/Caixa2/status.txt"); 
        $status_caixa2 = openssl_decrypt($status_caixa2, $cipher, $key, $options=0, $iv);
    }

    if( filesize("API/Files/Caixa2/hora.txt") == FALSE ){

        $hora_caixa2 = "Indisponivel";

    }else {
        $hora_caixa2 = file_get_contents("API/Files/Caixa2/hora.txt"); 
        $hora_caixa2 = openssl_decrypt($hora_caixa2, $cipher, $key, $options=0, $iv);
    }

    if( filesize("API/Files/Caixa3/status.txt") == FALSE ){

        $status_caixa3 = "N/A";

    }else {
        $status_caixa3 = file_get_contents("API/Files/Caixa3/status.txt"); 
        $status_caixa3 = openssl_decrypt($status_caixa3, $cipher, $key, $options=0, $iv);
    }

    if( filesize("API/Files/Caixa3/hora.txt") == FALSE ){

        $hora_caixa3 = "Indisponivel";

    }else {
        $hora_caixa3 = file_get_contents("API/Files/Caixa3/hora.txt"); 
        $hora_caixa3 = openssl_decrypt($hora_caixa3, $cipher, $key, $options=0, $iv);
    }
...
<head>
    ...
    <link rel="stylesheet" href="estadoCaixas.css">
...
<body>
    ...
    <div class="controlPage"> <!-- BARRA TOP COM NOTIFICAÇÕES E FOTO DE LOGIN -->
        ...
        <div class="cardsMainPage"> <!-- CARDS DAS CAIXAS -->
            <div class="card shadow-none rounded-0" >
                <div class="card-top">
                    <h1 class="heading">Caixa 1</h1> <!-- CAIXA 1 -->
                    <p class="caixa">
                        <span class="caixa-value" style= "font-size: 70px"><?php echo ($status_caixa1)?></span>
                    </p>
                </div>
                <div class="card-body">
                    <p class="card-text text-center">Atualização : <?php echo ($hora_caixa1)?></p>
                    <a href="API/historico.php?nome=Caixa1" style="text-decoration: none">
                        <div class="card">
            ...
            <div class="card shadow-none rounded-0" style="width: 450px; height: 750px">
                <div class="card-top">
                <h1 class="heading">Caixa 2</h1> <!-- CAIXA 2 -->
                <p class="caixa">
                    <span class="caixa-value" style= "font-size: 70px"><?php echo ($status_caixa2)?></span>
                </p>
                </div>
                <div class="card-body">
                    <p class="card-text text-center">Atualização : <?php echo ($hora_caixa2)?></p>
                    <a href="API/historico.php?nome=Caixa2" style="text-decoration: none">
                        <div class="card">
                                <span class="historicoText text-center">HISTORICO</span>
                        </div>
                    </a>
            ...
            <div class="card shadow-none rounded-0" >
                <div class="card-top">
                    <h1 class="heading">Caixa 3</h1> <!-- CAIXA 3 -->
                    <p class="caixa">
                        <span class="caixa-value" style= "font-size: 70px"><?php echo ($status_caixa3)?></span>
                    </p>
                </div>
                <div class="card-body">
                    <p class="card-text text-center">Atualização : <?php echo ($hora_caixa3)?></p>
                    <a href="API/historico.php?nome=Caixa3" style="text-decoration: none">
                        <div class="card">
                                <span class="historicoText text-center">HISTORICO</span>
                        </div>
                    </a>

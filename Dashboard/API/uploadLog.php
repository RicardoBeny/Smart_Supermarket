<?php 
    ...
    if(isset($_POST)){
        ...
        if( $_SERVER['REQUEST_METHOD'] == "POST") { /* se metodo post faz codigo */
            ...
            if (isset($_FILES['imagem'])){
                ...
                date_default_timezone_set('Europe/Lisbon'); /* escolher timezone da hora portugal */
    ...
    function write_date ($nome){ /* função para esrecver a data */

        $string = $nome; $string .= ";" ; $string .= date("d/m/y H:i:s");  $string .= "\n"; 

        /* como é a hora das fotos todas interessa o nome para poder distinguir*/
        /* mesmo formato que o log dos sensores */

        file_put_contents("Webcam/log.txt",$string,FILE_APPEND);
    }
